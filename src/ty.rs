use crate::{
    ...
    Print, TypeParamBound, TypeParamRef, GLOBAL_DATA,
};
...
impl TypeNode {
    pub(crate) fn get_name(&self) -> String {
        match self {
            ...
            TypeNode::TypeParam(type_param_ref) => GLOBAL_DATA
                .with_borrow_type_params(|params| params[type_param_ref.0].ident.to_string()),
